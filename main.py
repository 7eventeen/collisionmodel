...
# GLOBAL C-VARS
def constants():
    global tk_width, tk_height, m1, m2, v1, v2, box1h, box2h, box1w, box2w
    tk_width = 1280   #program width
    tk_height = 720  #program height
    m1 = 12  #mass of first object in system
    m2 = 122  #mass of second object in system
    v1 = 20   #velocity of second object in system before collision
    v2 = -5   #velocity of second object in system before collision
    box1h = 100
    box2h = 150
    box1w = 100
    box2w = 150
...
class System:
    def __init__(self):
        ...
        self.box1 = canvas.create_rectangle(self.box1x1, self.box1y1, self.box1x2, self.box1y2, fill='red')
        self.box2 = canvas.create_rectangle(self.box2x1, self.box2y1, self.box2x2, self.box2y2, fill='blue')
...
class GUI:
    def __init__(self):
        ...
        self.Label1_m1 = tk.Label(text='1st body options before interaction:',
                                  font=("Comic Sans MS", 22, "bold"), bg='#9e9e9e')
        ...
        self.Label2_m1_2 = tk.Label(text='m/s', font=("Arial 32", 16), bg='#9e9e9e')
        self.Label2_m1_2.place(relx=0.2515, rely=0.51)


        self.Label1_m2 = tk.Label(text='2nd body options before interaction:',
                                  font=("Comic Sans MS", 22, "bold"), bg='#9e9e9e')
        ...
        self.aLabel2_m1 = tk.Label(text='mass: dm = 0, ' + 'x' + ' kg', font=('Arial 32', 16), bg='#9e9e9e')
        ...
        self.aLabel2_m2 = tk.Label(text='mass: dm = 0, ' + 'x' + ' kg', font=('Arial 32', 16), bg='#9e9e9e')
...
def tick():
    system.move()
    print(system.v1, system.v2)
    root.after(70, tick)

def main():
    global root, canvas, line, system, GUI
    constants()
    root = tk.Tk()
